...
| ------------- | ------------- |  ------------- |
| Swift Beginnings | ALL banned moves may be used while labbing and pivoting. The normal restrictions on moves apply once you begin the first non-rival battle. | This allows the use of moves like Spore to speed up catches. |   
...
| Final Frontier | After Acquiring your 8th Gym badge, you gain one Bonus Pokémon Centre usage.  | Changed as of 21/11/25 - Battle Items are now usable for the entire run |
...
| Savvy Shopper | You may buy up to 15 regular potions total after beating the first Gym. | These should be bought asap. As of 21/11/25, this has been increased from 10 to 15. |
...
### Fire Red / Leaf Green
321WRIEEjIBAAQABwCRAAKeBhsECQEAiAACCQAuEgAAAAAABRi45ATkAYYICTIGBAIyGwUYAAUYuAAAAAAQRmlyZSBSZWQgKFUpIDEuMbg+8HR8673t
